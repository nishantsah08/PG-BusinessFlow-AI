...
## Purpose
Provides vertical navigation linking to the primary system interfaces (`/master`, `/property`, `/crm`, and developer-mode `/dashboard`). Persists across authenticated routes.

## Scope
- Render navigation links styled as pills (Master AI, Property & Booking, CRM, and developer-mode Agent Dashboard).
...
- `lucide-react`: `MessageSquareCode`, `Building2`, `Users`, `Activity` icons.

...
## Purpose
Provides vertical navigation linking to the primary system interfaces (`/master`, `/workflows`, `/property`, `/crm`, `/hr`, `/finance`, and developer-mode `/dashboard`). Persists across authenticated routes.

## Scope
- Render navigation links styled as pills (Master AI, SOPs, Property & Booking, CRM, HR, Finance, and developer-mode Agent Dashboard).
...
- `lucide-react`: `MessageSquareCode`, `GitBranch`, `Building2`, `Users`, `UserRound`, `Banknote`, `Activity` icons.

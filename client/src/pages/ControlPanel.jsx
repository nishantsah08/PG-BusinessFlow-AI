...
const ControlPanel = () => {
    ...
    return (
        <div className="h-full flex flex-col md:flex-row overflow-hidden bg-white">
            ...
            <div className={`w-full ${isDeveloperMode && isDevViewOpen ? 'md:w-3/5' : 'md:flex-1'} h-1/2 md:h-full flex flex-col border-b md:border-b-0 ${isDeveloperMode ? 'md:border-r border-gray-200' : ''} transition-all duration-300`}>
